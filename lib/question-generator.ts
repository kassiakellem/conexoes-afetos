...
const seedQuestions: CategoryContent = {
  casual: [
    ...
    "Se você pudesse viver um dia da sua vida de novo, qual seria?",
    "Qual é o seu lanche ou comida preferida de infância?",
    "Qual hábito bobo você tem e acha divertido?",
    "Se você tivesse que escolher um lugar para morar por um ano, qual seria?",
    "Qual foi a melhor coisa que aconteceu com você essa semana?",
    "Você é mais da madrugada ou do dia?",
    "Qual música te faz dançar mesmo que esteja triste?",
    "Tem alguma superstição que você segue?",
    "Se pudesse ter qualquer habilidade instantaneamente, qual escolheria?",
  ],
  fun: [
    ...
    "Qual foi a situação mais constrangedora (mas engraçada) que você já viveu?",
    "Se sua vida virasse uma comédia, qual seria o título?",
    "Qual foi o maior mico que você já pagou em público?",
    "Qual habilidade inútil você tem e se orgulha?",
    "Se você fosse um meme, qual seria?",
    "Qual é a mentira mais boba que você já contou e quase acreditaram?",
    "Qual foi o sonho mais bizarro ou aleatório que você já teve?",
    "Você já riu numa hora totalmente errada? Conta aí!",
    "Se você pudesse trocar de corpo com alguém por um dia, quem seria e o que faria?",
    "Qual o apelido mais engraçado (ou bizarro) que já te deram?",
  ],
  deep: [
    ...
    "O que você mais teme que os outros descubram sobre você?",
    "Qual foi a dor emocional mais marcante da sua vida e como ela te transformou?",
    "Quando foi a última vez que você se sentiu genuinamente amado(a)?",
    "Qual parte de você ainda está em processo de cura?",
    "Se você pudesse mandar uma mensagem para sua criança interior, o que diria?",
    "Você perdoou completamente alguém que te feriu profundamente? Por quê?",
    "O que você sente falta que não sabe como pedir?",
    "Quando foi a última vez que você chorou? Por quê?",
    "Qual sua maior contradição interna?",
    "O que você gostaria que as pessoas entendessem sobre você sem que você precise explicar?",
    "Que parte de você você esconde para não ser rejeitado(a)?",
    "Qual é a maior mentira que você já contou pra si mesmo(a)?",
    "O que o amor significa de verdade pra você?",
    "Qual é o seu medo mais silencioso?",
    "Qual é a sua verdade que você evita encarar?",
  ],
  romantic: [
    ...
    "Como é a sua definição de um amor saudável?",
    "Você acredita em amor à primeira vista? Já sentiu algo assim?",
    "Qual gesto romântico te marca mais: palavras, ações ou toque?",
    "O que mais te faz sentir conectado(a) a alguém?",
    "Qual foi o momento mais romântico da sua vida até agora?",
    "O que te faz se apaixonar por alguém?",
    "Qual é sua linguagem do amor favorita?",
    "Você prefere amar intensamente e se machucar ou nunca se arriscar?",
    "Já se apaixonou por alguém que era só amigo(a)?",
    "Que tipo de carinho mais te acalma e te faz sentir cuidado(a)?",
  ],
  erotic: [
...
const seedChallenges: CategoryContent = {
  casual: [
    ...
    "Desafio: Imite o seu emoji favorito com o rosto.",
    "Desafio: Conte uma curiosidade aleatória sobre você que pouca gente sabe.",
    "Desafio: Escolha alguém e invente um apelido carinhoso pra ela(e) na hora.",
    "Desafio: Dance por 10 segundos uma música imaginária como se ninguém estivesse olhando.",
    "Desafio: Faça uma dublagem dramática da última mensagem que recebeu no WhatsApp.",
    "Desafio: Mande um elogio criativo para alguém do grupo.",
    "Desafio: Mostre a última foto da sua galeria (se for confortável).",
    "Desafio: Fale três verdades e uma mentira sobre você — e o grupo tenta adivinhar qual é a mentira.",
    "Desafio: Crie um bordão engraçado pra você e fale com emoção.",
    "Desafio: Diga o que faria se ganhasse um milhão de reais agora.",
  ],
  fun: [
    ...
    "Desafio: Fale com um sotaque aleatório por um minuto inteiro.",
    "Desafio: Imite um animal à sua escolha — com som e tudo.",
    "Desafio: Recrie uma cena dramática de novela mexicana com exagero total.",
    "Desafio: Mostre sua dança mais esquisita sem vergonha nenhuma.",
    "Desafio: Invente uma cantada tosca na hora e mande para alguém do grupo.",
    "Desafio: Fale uma frase sensual como se estivesse com a boca cheia de pão.",
    "Desafio: Faça uma propaganda de um produto inútil como se fosse revolucionário.",
    "Desafio: Diga seu nome completo como se estivesse chorando desesperado(a).",
    "Desafio: Escolha alguém e façam um duelo de caretas — o grupo escolhe o(a) vencedor(a).",
    "Desafio: Diga 3 verdades absurdas como se fossem super normais (o grupo precisa descobrir se são reais).",
  ],
  deep: [
    ...
    "Desafio: Olhe nos olhos de alguém por 1 minuto sem falar nada e depois diga o que sentiu.",
    "Desafio: Conte sobre uma dor que você costuma esconder das pessoas.",
    "Desafio: Escolha alguém e compartilhe um momento em que você se sentiu frágil ou sozinho(a).",
    "Desafio: Diga algo que você nunca teve coragem de contar em voz alta, nem para os mais próximos.",
    "Desafio: Escreva uma carta para alguém que te magoou profundamente — e leia em voz alta.",
    "Desafio: Fale sobre um erro que cometeu e que ainda sente culpa.",
    "Desafio: Olhe para alguém do grupo e diga uma qualidade que admira nela(e), com sinceridade.",
    "Desafio: Descreva um momento em que você se sentiu fracassado(a), mas aprendeu algo importante.",
    "Desafio: Compartilhe uma decisão que você gostaria de ter feito diferente.",
    "Desafio: Diga em voz alta: 'Hoje, eu preciso aprender a lidar com...' — e complete com sinceridade.",
    "Desafio: Pense em alguém que você sente saudade e diga o nome e o porquê dessa saudade.",
    "Desafio: Fale uma coisa que você acha bonita em si mesmo(a) e uma que ainda está tentando aceitar.",
    "Desafio: Feche os olhos, respire fundo e diga o que mais te angustia no momento presente.",
    "Desafio: Conte sobre um momento em que alguém acreditou em você quando você não acreditava.",
    "Desafio: Escolha alguém e compartilhe algo que nunca contou pra quase ninguém.",
  ],
  romantic: [
    ...
    "Desafio: Diga para alguém aqui o que você mais gostou nela(e) desde que se conheceram.",
    "Desafio: Faça um elogio sincero para a pessoa à sua direita — sem pensar muito.",
    "Desafio: Olhe para alguém como se estivesse apaixonado(a) por ela(e) por 20 segundos.",
    "Desafio: Escreva uma mensagem de amor curta como se fosse para o seu crush ou amor ideal.",
    "Desafio: Diga qual seria o encontro perfeito pra você — e com quem faria se pudesse escolher agora.",
    "Desafio: Conte qual foi o gesto de amor mais simples que te marcou profundamente.",
    "Desafio: Faça um carinho simbólico em alguém (como um toque leve no ombro, se houver consentimento).",
    "Desafio: Crie uma declaração de amor improvisada usando 3 palavras aleatórias escolhidas pelo grupo.",
    "Desafio: Compartilhe uma memória afetiva que te faz sorrir até hoje.",
    "Desafio: Escolha alguém e diga: 'se a gente tivesse uma história juntos, começaria assim…' — e invente o começo.",
  ],
  erotic: [
    ...
    "Desafio: Diga algo sujo no ouvido de alguém — o mais safado que conseguir (com consentimento).",
    "Desafio: Dê um beijo no pescoço de alguém por 10 segundos (com consentimento).",
    "Desafio: Escolha alguém e descreva como seria uma noite com essa pessoa em detalhes sensuais.",
    "Desafio: Envie uma mensagem de voz simulando gemidos para alguém do grupo (se todos estiverem confortáveis).",
    "Desafio: Mostre como você faria uma massagem sensual em alguém usando gestos no ar.",
    "Desafio: Simule uma cena de sedução como se estivesse em um filme adulto, sem usar palavrões.",
    "Desafio: Conte qual foi o lugar mais inusitado onde você já teve (ou gostaria de ter) uma experiência íntima.",
    "Desafio: Sente no colo de alguém por um minuto inteiro (com consentimento).",
    "Desafio: Escolha alguém para te dar um beijo em uma parte do corpo que não seja a boca.",
    "Desafio: Faça um strip-tease leve (mantendo roupa íntima ou o limite que se sentir confortável).",
    "Desafio: Imite o som que você faz quando sente muito prazer — pode ser real ou inventado!",
    "Desafio: Diga algo sujo no ouvido de alguém — o mais safado que conseguir (com consentimento).",
    "Desafio: Escolha alguém e diga onde gostaria de ser tocado(a) por ela(e).",
    "Desafio: Faça um gemido alto e realista como se estivesse no auge do prazer.",
    "Desafio: Provoque alguém do grupo usando apenas os olhos por 30 segundos.",
    "Desafio: Lamba lentamente um dedo como se estivesse provocando alguém.",
    "Desafio: Descreva com detalhes como seria a sua 'noite perfeita' a dois (ou mais).",
    "Desafio: Escolha alguém e diga o que faria com ela(e) se estivessem a sós agora.",
    "Desafio: Mostre como seria um beijo de cinema... usando a própria mão como se fosse a outra pessoa.",
    "Desafio: Dê uma mordidinha leve (ou simule) em alguém do grupo (com consentimento).",
    "Desafio: Recrie uma cena quente de um filme ou série que tenha te marcado.",
    "Desafio: Escolha alguém e diga onde mais sente prazer além das zonas óbvias.",
    "Desafio: Faça uma dancinha provocante olhando diretamente para alguém específico.",
    "Desafio: Encoste seu corpo em alguém lentamente por 5 segundos (com o ok da pessoa).",
    "Desafio: Conte o que faria agora se estivesse completamente sem roupas com alguém do grupo.",
    "Desafio: Simule uma ligação erótica como se estivesse seduzindo alguém à distância.",
    "Desafio: Simule com a boca e a língua como você faria sexo oral em alguém do grupo (com consentimento e sem ou com contato direto).",
    "Desafio: Mostre (com gestos e expressão) como seria te ver entre as pernas de alguém.",
    "Desafio: Olhe para alguém e diga: 'se eu estivesse entre suas pernas agora, faria isso...' — e complete.",
    "Desafio: Chegue bem perto de alguém e diga, no ouvido: ‘me deixa te chupar até você esquecer seu nome’.",
    "Desafio: Olhe alguém nos olhos e diga: ‘me mostra o caminho que eu vou até o fim com a língua’.",
    "Desafio: Use um objeto (ou a própria mão) para mostrar onde você começaria a chupar… e onde terminaria.",
    "Desafio: Encoste na perna de alguém e sussurre como você deixaria ela(e) molhada(o) ou duro só com a boca.",
    "Desafio: Escolha alguém e diga, com todos os detalhes, como você transaria com ela(e) se estivessem a sós agora.",
    "Desafio: Simule com a boca como você chupa uma pica ou uma buceta do jeitinho que você gosta.",
    "Desafio: Olhe alguém do grupo nos olhos e diga onde você gostaria de ser lambido(a) agora.",
    "Desafio: Pegue a mão de alguém e guie até onde você gostaria de ser tocado(a) — mesmo que seja no ar.",
    "Desafio: Descreva com voz baixa e provocante sua posição favorita na cama e o que fazem com você nela.",
    "Desafio: Mostre como você cavalga ou rebola no sexo — com as mãos no ar, no chão ou no colo de alguém (com consentimento).",
    "Desafio: Encoste em alguém e diga: ‘nesse momento, eu te colocaria de quatro e faria isso…’ — e complete.",
    "Desafio: Sussurre algo sujo no ouvido de alguém e termine com um beijo onde a pessoa deixar.",
    "Desafio: Escolha alguém e diga onde você goza mais: na boca, na cara, no peito ou dentro?",
    "Desafio: Imite com a mão e o corpo como você se masturba quando está com muito tesão.",
    "Desafio: Diga o nome de quem você escolheria para transar aqui e agora — e o porquê.",
    "Desafio: Conte uma situação real ou imaginada em que você foi (ou gostaria de ser) usado(a) e dominado(a).",
    "Desafio: Beije alguém como se estivesse prestes a transar com ela(e) — se a pessoa topar.",
    "Desafio: Mostre, com gestos e palavras, como você dá ou leva uma palmada na cama.",
    "Desafio: Fale o que você quer que façam com você hoje à noite, sem censura.",
    "Desafio: Escolha alguém para bater ou aperta sua bunda.",
  ],
};
